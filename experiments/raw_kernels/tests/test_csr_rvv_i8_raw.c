 ...
 *
 * Correctness test for experimental CSR SpGEMM RVV INT8 raw kernel.
 */
...
static void assert_same_csr_i32(int32_t rows, const int32_t *ref_row_ptr, const int32_t *ref_col_idx,
                                const int32_t *ref_values,
                                int32_t ref_nnz,
                                const int32_t *test_row_ptr,
                                const int32_t *test_col_idx,
...
int main(void)
{
    ...
    status = exp_spgemm_csr_scalar_i8_reference_raw(a_rows, a_cols, b_cols,
                                                    a_row_ptr,
                                                    a_col_idx,
                                                    a_values,
                                                    b_row_ptr,
    ...
    status = exp_spgemm_csr_rvv_i8_raw(a_rows, a_cols, b_cols,
                                       a_row_ptr,
                                       a_col_idx,
                                       a_values,
                                       b_row_ptr,
    ...
    printf("test_csr_rvv_i8_raw: PASS [RVV path]\n");
#else
    printf("test_csr_rvv_i8_raw: PASS [scalar fallback path]\n");
#endif
