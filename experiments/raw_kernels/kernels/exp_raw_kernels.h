...
rvsp_status_t exp_accumulate_row_i8_rvv_indexed(
    int8_t a_val,
    int32_t b_nnz,
    const int32_t *b_col_idx,
    const int8_t *b_values,
...
rvsp_status_t exp_spgemm_csr_rvv_i8_indexed_raw(
    int32_t a_rows,
    int32_t a_cols,
    int32_t b_cols,
    const int32_t *a_row_ptr,
...
rvsp_status_t exp_accumulate_row_i8_rvv_indexed_fast(
    int8_t a_val,
    int32_t b_nnz,
    const int32_t *b_col_idx,
    const int8_t *b_values,
...
rvsp_status_t exp_spgemm_csr_rvv_i8_indexed_marked_raw(
    int32_t a_rows,
    int32_t a_cols,
    int32_t b_cols,
    const int32_t *a_row_ptr,
