 ...
 *
 * Experimental CSR SpGEMM RVV INT8 raw kernel.
...
rvsp_status_t exp_spgemm_csr_rvv_i8_raw(int32_t a_rows, int32_t a_cols, int32_t b_cols,
                                        ...
                                        int32_t *c_nnz_out)
{
    ...
    for (int32_t row = 0; row < a_rows; row++)
    {
        ...
        for (int32_t a_pos = a_start; a_pos < a_end; a_pos++)
        {
            ...
            rvsp_status_t status = exp_accumulate_row_i8_rvv(a_val, b_nnz, &b_col_idx[b_start],
                                                             &b_values[b_start],
                                                             b_cols,
                                                             acc);
